...
<span class="token comment"># install docker-compose bash command completion</span>
<span class="token function">sudo</span> <span class="token function">curl</span> <span class="token punctuation">\\</span>
    -L https://raw.githubusercontent.com/docker/compose/<span class="token variable">\${compose_ver}</span>/contrib/completion/bash/docker-compose <span class="token punctuation">\\</span>
